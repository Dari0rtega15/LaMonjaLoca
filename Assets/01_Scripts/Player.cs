...
public class Player : MonoBehaviour
{
    ...
    public float maxHealth = 20f;           // Vida máxima del jugador
    ...
    void Start()
    {
        ...
        {
            Debug.LogWarning("No se encontró el objeto con el tag 'LifeBar'.");
        }
    }
    ...
    public void TakeDamage(float damage)
    {
        ...
        Debug.Log("Player ha recibido daño. Vida actual: " + currentHealth);
